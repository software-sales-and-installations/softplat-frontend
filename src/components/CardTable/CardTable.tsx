        ...
        <table>
            <thead>
                <tr className={classNames(styles.line, styles.line_type_head)}>
                    {role==='ADMIN'? <th className={classNames(styles.cellLogo, styles.cell)}>Выбрать</th>: null}
                    {role==='SELLER'? <th className={classNames(styles.cellLogo, styles.cell)}>Лого</th> : null}
